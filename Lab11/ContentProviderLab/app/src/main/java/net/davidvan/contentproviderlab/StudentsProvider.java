package net.davidvan.contentproviderlab;
...
public class StudentsProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "net.davidvan.provider.College";
    ...
    static final String DATABSE_NAME = "College";
    ...
    public boolean onCreate() {
        ...
        // Create a writable database with will trigger its
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            ...
            case STUDENTS:
                return "vnd.android.cursor.dir/vnd.davidvan.students";
            // Get a particular student
            case STUDENT_ID:
                return "vnd.android.cursor.item/vnd.davidvan.students";
            default:
